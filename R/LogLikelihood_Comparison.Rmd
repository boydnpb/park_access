...
### Boston SEM Models
Models 3 and 6 are most likely for all three dependent variables.
...
### Boston SDM Models
Models 1 and 3 are most likely for all three dependent variables.
...
NYC_SEM_Loglikelihoods[,4] <- c(-3929.14, -3929.14, -3929.36)
...
NYC_SDM_Loglikelihoods[,4] <- c(-3808.52, -3808.53, -3812.65)
NYC_SDM_Loglikelihoods[,5] <- c(-4368.97, -4368.96, -4368.45)
