...
#tract_shapes <- list(nyc_tracts, boston_tracts, denver_tracts)
park_shapes <- list(boston_parks, denver_parks, nyc_parks)
#park_shapes <- list(denver_parks, boston_parks, nyc_parks)
#park_shapes <- list(nyc_parks, boston_parks, denver_parks)
```
...
#regression_data[[1]]["park_ls"] <- calculate_park_logsums(
  #denver_tracts, denver_parks, betas = c(.00001, -15))
regression_data[[1]]["park_ls"] <- calculate_park_logsums(
  boston_tracts, boston_parks, betas = c(.00001, -5))
#regression_data[[1]]["park_ls"] <- calculate_park_logsums(
  #nyc_tracts, nyc_parks, betas = c(.00001, -15))
#regression_data[[2]]["park_ls"] <- calculate_park_logsums(
 # boston_tracts, boston_parks, betas = c(.00001, -30))
#regression_data[[3]]["park_ls"] <- calculate_park_logsums(
